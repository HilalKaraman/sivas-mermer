...
type CategoryType = "dis-cephe" | "asansor" | null;

export default function MermerKaplamaClient() {
    const [selectedCategory, setSelectedCategory] = useState<CategoryType>(null);
    const [currentPage, setCurrentPage] = useState(1);
    const sectionRef = useRef<HTMLElement>(null);
    const itemsPerPage = 6;

    const disCepheProducts = [
        {
            code: "K001",
            title: "Duvar Kaplama",
    ...
    const asansorProducts: typeof disCepheProducts = [
        {
            code: "AK001",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama1.jpg"),
            desc: "Asansör girişleri ve iç mekanları için tasarlanmış şık mermer kaplama uygulaması.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK002",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama2.jpg"),
            desc: "Binalarınıza lüks bir görünüm kazandıran dayanıklı asansör dış mermer kaplamaları.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK003",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama3.jpg"),
            desc: "Projeye özel ölçülendirilmiş estetik ve uzun ömürlü asansör kaplama çözümleri.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK004",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama4.jpg"),
            desc: "Asansör sövelerine zarafet katan doğal taş ve mermer uygulama modeli.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK005",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama5.jpg"),
            desc: "İnce işçilik ve kusursuz detaylarla hazırlanan özel asansör yüzey kaplamaları.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK006",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama6.jpg"),
            desc: "Mekan prestijini artıran modern ve pürüzsüz mermer asansör kaplama tasarımı.",
            price: "Fiyat Teklifi Al"
        },
        {
            code: "AK007",
            title: "Asansör Kaplama",
            image: img("/asansor-kaplama7.jpg"),
            desc: "Geniş renk ve doku seçenekleriyle uygulanan asansör etrafı mermer işçiliği.",
            price: "Fiyat Teklifi Al"
        }
    ];

    const products = selectedCategory === "dis-cephe" ? disCepheProducts : (selectedCategory === "asansor" ? asansorProducts : []);
    ...
    const categories = [
        { id: "dis-cephe" as CategoryType, title: "Dış Cephe Kaplama", image: img("/kaplama-urun4.png"), desc: "Binalarınızın dış görünümüne prestij ve değer katan, her türlü hava koşuluna dayanıklı mermer dış cephe kaplamaları." },
        { id: "asansor" as CategoryType, title: "Asansör Kaplama", image: img("/kaplama-urun5.png"), desc: "Bina girişleri ve asansör iç/dış yüzeyleri için şık ve estetik mermer tasarım uygulamaları." }
    ];
        ...
        <section ref={sectionRef} className="py-24 bg-[var(--cream-dark)] relative overflow-hidden min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-[var(--charcoal)] mb-4">Mermer Kaplama Uygulamaları</h2>
                    <div className="w-24 h-1 bg-[var(--gold)] mx-auto rounded-full"></div>
                    <p className="mt-4 text-[var(--grey-medium)] max-w-2xl mx-auto">
                        {selectedCategory === null
                            ? "Mekanlarınıza değer katan, estetik ve dayanıklı mermer dış cephe ve asansör kaplama çözümleri."
